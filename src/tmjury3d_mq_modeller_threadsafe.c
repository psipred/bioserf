    ...
    char          **argv;
{
    ...
    ifp = fopen(argv[4], "r");	/* Open PDB file in TEXT mode */
    if (!ifp)
    {
...
#if 0
    /* Rescore top ntemplates*2 models with MQAP score */
    for (moda=0; moda<ntemplates*2; moda++)
